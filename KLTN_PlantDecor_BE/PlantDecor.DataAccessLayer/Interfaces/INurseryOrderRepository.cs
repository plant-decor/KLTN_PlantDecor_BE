...
namespace PlantDecor.DataAccessLayer.Interfaces
{
    public interface INurseryOrderRepository : IGenericRepository<NurseryOrder>
    {
        ...
        Task<decimal> GetNetPaidSystemRevenueAsync(DateTime fromInclusive, DateTime toExclusive);
        Task<int> CountPaidSystemOrdersAsync(DateTime fromInclusive, DateTime toExclusive);
        Task<List<NurseryRevenueAggregate>> GetNetPaidRevenueByNurseryListAsync(DateTime fromInclusive, DateTime toExclusive);
