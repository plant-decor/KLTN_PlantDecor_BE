...
namespace PlantDecor.DataAccessLayer.Migrations
{
    ...
    [Migration("20260223172529_Update Tag Category PlantInventory")]
    partial class UpdateTagCategoryPlantInventory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PlantDecor.DataAccessLayer.Entities.PlantInventory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasKey("Id")
                        .HasName("PlantInventory_pkey");

                    b.HasIndex("NurseryId");

                    b.HasIndex("PlantId");

                    b.ToTable("PlantInventory", (string)null);
                });
            ...
            modelBuilder.Entity("PlantDecor.DataAccessLayer.Entities.Invoice", b =>
                {
                    b.HasOne("PlantDecor.DataAccessLayer.Entities.Order", "Order")
                        .WithOne("Invoice")
                        .HasForeignKey("PlantDecor.DataAccessLayer.Entities.Invoice", "OrderId")
