namespace PlantDecor.DataAccessLayer.Enums
{
    ...
    {
        Pending = 0, // tạo đơn hàng nhưng chưa thanh toán
        DepositPaid = 1, // đã thanh toán tiền đặt cọc, chờ thanh toán phần còn lại
        Paid = 2, // đã thanh toán đầy đủ, chờ xử lý đơn hàng
        ...
        Completed = 7, // đã hoàn thành, đã thanh toán đầy đủ và xác nhận đã nhận được hàng
        Cancelled = 8, // đã hủy, có thể do khách hàng hủy trước khi thanh toán hoặc do nhân viên hủy sau khi thanh toán
        Failed = 9, // đã thất bại, có thể do thanh toán thất bại hoặc do vấn đề xử lý đơn hàng
